...
## 支持的文档类型
- 起诉状：提取案由、当事人、诉讼请求、事实与理由
- 答辩状：提取答辩观点、反驳事实、反驳法律依据
- 证据材料：提取证据内容、证明目的、关联性分析
- 庭审笔录：提取争议焦点、当事人陈述、举证质证
- 法院传票：提取案号、法院名称、开庭时间、地点
- 举证通知书：提取案号、举证期限、证据要求
- 送达回证：提取案号、送达内容、送达时间、当事人签收
- 压缩包：自动解压，批量处理内部文件
