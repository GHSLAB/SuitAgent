...
- **[智谱AI开放平台](https://open.bigmodel.cn/)** - GLM-4.7
- **[月之暗面开放平台](https://platform.moonshot.cn/)** - kimi-k2-turbo
- **[MiniMax开放平台](https://www.minimaxi.com/)** - MiniMax-M2.1
...
- 或下载 `CC-Switch-v{版本号}-Linux.AppImage` 安装包🚀 快速开始
...
- **[智谱AI开放平台](https://open.bigmodel.cn/)** - GLM-4.7，推荐⭐⭐⭐⭐⭐
- **[月之暗面开放平台](https://platform.moonshot.cn/)** - kimi-k2-turbo，推荐⭐⭐⭐⭐⭐
- **[MiniMax开放平台](https://www.minimaxi.com/)** - MiniMax-M2.1，免费API，推荐⭐⭐⭐⭐
