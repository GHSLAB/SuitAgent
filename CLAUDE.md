...
- **DocAnalyzer** → `02 - 📄 案件分析/` - 案件分析报告、当事人信息、诉讼请求
- **Strategist** → `02 - 📄 案件分析/` - 策略方案、SWOT分析、风险评估
- **IssueIdentifier** → `03 - 🔍 法律研究/` - 争议焦点列表、焦点分析
- **Researcher** → `03 - 🔍 法律研究/` - 法律研究报告、法条检索、判例研究
- **EvidenceAnalyzer** → `05 - 📎 证据材料/` - 证据目录、质证意见、补充证据建议
- **Writer** → `06 - 📝 法律文书/[具体文书类型]/` - 各类法律文书按需分类存储
- **Summarizer** → `10 - 📊 综合报告/` - 案件摘要、风险摘要
- **Reporter** → `10 - 📊 综合报告/` - 综合分析报告、阶段进展报告
- **Scheduler** → `00 - 📅 日程管理/` - 期限提醒、工时统计、日程安排 (支持YAML+MD双版本)
